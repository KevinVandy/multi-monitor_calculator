...
<Wrapper>
  ...
  <Tooltip>
    Move Monitor Forward. WARNING, Moving Monitor forward makes the monitor
    appear bigger than it is!</Tooltip
  >
</Wrapper>
<Wrapper>
  <IconButton
  ...
  <Tooltip>
    Move Monitor Backward. WARNING, Moving Monitor backward makes the monitor
    appear smaller than it is!</Tooltip
  >
</Wrapper>
