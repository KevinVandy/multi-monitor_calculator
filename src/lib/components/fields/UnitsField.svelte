<script lang="ts">
	...
	import { inputUnits, statUnits } from '$lib/stores/SettingsStore';
	import { monitors } from '$lib/stores/SetupStore';

	const onInputUnitsChange = (event: any) => {
...
<div>
	...
	{#each ['Imperial', 'Metric'] as option}
		<FormField>
			<Radio on:change={onInputUnitsChange} bind:group={$inputUnits} value={option} touch />
