<script lang="ts">
	...
	import { monitors, scale, getNewMonitor, deskWidth, deskHeight } from '$lib/stores/SetupStore';
...
<div class="zoom-button-container">
	<Wrapper>
		<Fab aria-label="Zoom Out" color="secondary" on:click={() => $scale > 1 && $scale--}>
			<Icon class="material-icons">zoom_out</Icon>
		</Fab>
		<Tooltip>Zoom Out</Tooltip>
	</Wrapper>
	<Wrapper>
		<Fab aria-label="Zoom In" color="secondary" on:click={() => $scale < 32 && $scale++}>
	...
	<Wrapper>
		...
		>
			<Icon class="material-icons" style="transform:rotate(90deg);">unfold_less</Icon>
		</Fab>
	...
	<Wrapper>
		...
		>
			<Icon class="material-icons" style="transform:rotate(90deg);">unfold_more</Icon>
		</Fab>
